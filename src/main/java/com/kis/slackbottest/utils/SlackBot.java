package com.kis.slackbottest.utils;
...
/**
 * Created by Hernando on 02/22/2017.
 */
@Component
public class SlackBot extends Bot {
    ...
    public void onReceiveDM(WebSocketSession session, Event event) {
        event.setText(event.getText().replaceFirst("<@([A-Z])\\w+>", ""));
        reply(session, event, new Message(event.getText()));
    }
